      ...
      <div className="flex-1">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Meet the students and teacher working on this project</p>
          </div>
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {teachers.map((teacher) => (
                  <div
                    key={teacher.id}
                    className="bg-white rounded-xl p-6 card-shadow hover:card-shadow-hover transition-all border border-gray-100 text-center"
                  >
                    ...
                    <p className="text-gray-500 text-xs mt-3">{teacher.email}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {students.map((student) => (
                ...
                >
                  ...
                  <p className="text-red-600 font-medium mb-3">{student.role}</p>
