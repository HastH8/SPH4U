				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
					<div className="flex items-center justify-between mb-8">
						...
						<button
							...
							className="btn-primary flex items-center gap-2 font-medium disabled:opacity-60 disabled:cursor-not-allowed px-6 py-3"
							disabled={!isLoggedIn}
						>
						...
						<div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 flex items-center gap-3">
							...
							<div className="flex-1">
								...
								<p className="text-xs text-red-600 mt-1">
									You need to be logged in to add or edit calendar events.
								</p>
							</div>
							<button
					...
					<div className="page-card p-6 mb-6">
						...
						<div className="grid grid-cols-7 gap-0">
							{weekDays.map((day) => (
								<div
									key={day}
									className="p-2 text-center font-semibold text-gray-700 bg-gray-100"
								>
									{day}
								</div>
							))}
					...
					<div className="bg-white rounded-xl card-shadow border border-gray-100 p-6">
						...
						<div className="space-y-3">
							{events
								...
								.filter(
									(e) =>
										new Date(e.date + "T" + (e.time || "00:00")) >= new Date()
								)
								.slice(0, 5)
								.map((event) => (
									<div
