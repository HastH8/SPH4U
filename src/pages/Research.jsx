          ...
          {showUpload && (
            <div className="bg-white rounded-xl p-4 sm:p-6 card-shadow mb-8 border border-gray-100">
              <div className="flex items-center justify-between mb-4 gap-4">
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-900">Upload Research Paper</h2>
                <button
                  onClick={() => {
                    setShowUpload(false)
                    setFormData({
                  ...
                  <div>
                    ...
                    <label className="cursor-pointer">
                      ...
                      <div className="flex items-center gap-2 px-3 sm:px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <span className="text-xs sm:text-sm text-gray-700">Add Images</span>
                      </div>
                    </label>
                  </div>
                </div>
            ...
            {papers.map((paper) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-500">{formatDate(paper.uploadDate)}</span>
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 break-words">{paper.title}</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-3">By {paper.author}</p>
                <p className="text-sm sm:text-base text-gray-700 mb-4 line-clamp-3 break-words">{paper.description}</p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-xl p-4 sm:p-6 max-w-4xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto card-shadow">
            <div className="flex items-start justify-between mb-4 gap-4">
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 break-words flex-1">{viewingPaper.title}</h2>
              <button
            ...
            <div className="space-y-4">
              <div>
                <p className="text-sm text-gray-600">By {viewingPaper.author}</p>
                <p className="text-sm text-gray-500">{formatDate(viewingPaper.uploadDate)}</p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Description</h3>
                <p className="text-gray-700 text-sm sm:text-base break-words">{viewingPaper.description}</p>
              </div>
              {viewingPaper.content && (
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Content</h3>
              ...
              {viewingPaper.images && viewingPaper.images.length > 0 && (
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Images & Diagrams</h3>
              ...
              {viewingPaper.file && (
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Attached File</h3>
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 bg-gray-50 p-3 rounded-lg">
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                      ...
                      <span className="text-gray-700 text-sm sm:text-base truncate">{viewingPaper.file}</span>
                    </div>
